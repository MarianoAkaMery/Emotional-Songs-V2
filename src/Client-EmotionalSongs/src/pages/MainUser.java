...
public class MainUser extends JFrame implements ActionListener {
    ...
    private Image avatarImage = Constant.UserProfile.getImage().getScaledInstance(100, 100, Image.SCALE_SMOOTH);
    private ImageIcon resizedAvatarIcon = new ImageIcon(avatarImage);

    /**
     * Constructs a MainUser object.
     * Initializes the main user interface with components and sets up event listeners.
     *
    ...
    public MainUser(User LoggedUser) {
        ...
        // Adding change and selection listeners
    ...
    /**
     * Custom renderer for list buttons.
     * This class extends JButton and implements ListCellRenderer to render buttons in JList.
     */
