 ...
 */
public class SongPage extends JFrame implements ActionListener {
    ...
    private JButton buttonDelete = new JButton("Delete Song");
    private String nameSongToDelete;
    ...
    public SongPage(String[] songProfile) {
        super("Song");
        nameSongToDelete = songProfile[1];
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == buttonDelete) {
            ...
            deleteAction = app.deleteSong(nameSongToDelete);
            if (deleteAction) {
                JOptionPane.showMessageDialog(this, "Successfully deleted song", "User-Notification", JOptionPane.INFORMATION_MESSAGE);
            } else {
                JOptionPane.showMessageDialog(this, "Unable to delete song", "User-Notification", JOptionPane.ERROR_MESSAGE);
            }
            this.dispose();
        }
    }
