...
import pagesResult.PlaylistPage;

/**
 * This class represents PageThree of the application.
 */
public class PageThree extends JFrame implements ActionListener {
    ...
    /**
     * Creates an instance of PageThree.
     */
    public PageThree() {
        super("EmotionalSongs Playlist");

        // Adding data to our list + DB
        DbConnector app = new DbConnector();
        DummyData = app.getPlaylistInfo();
        PlayListList = Functions.refactorData(DummyData);

        elementList = new JList<>(PlayListList);
        elementList.setCellRenderer(new ButtonRenderer());

        // Button Layout
        slider = new JSlider(JSlider.HORIZONTAL, 1, PlayListList.length, 1);
        ...
        slider.addChangeListener(new ChangeListener() {
            ...
            public void stateChanged(ChangeEvent e) {
                ...
                System.arraycopy(PlayListList, 0, displayedElements, 0, value);
            ...
            public void valueChanged(ListSelectionEvent e) {
                if (!e.getValueIsAdjusting()) {
                    ...
                    if (selectedElement != null) {
                        ...
                        DbConnector app = new DbConnector();
                        Playlist = app.getSinglePlaylistInfo(selectedElement);
