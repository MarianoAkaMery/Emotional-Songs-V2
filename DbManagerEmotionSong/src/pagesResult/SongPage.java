    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == buttonDelete) {
            ...
            if (deleteAction == true) {
                JOptionPane.showMessageDialog(this, "Successfully deleted song", "Song-Notification", JOptionPane.INFORMATION_MESSAGE);
            } else {
                JOptionPane.showMessageDialog(this, "Unable to delete song", "Song-Notification", JOptionPane.ERROR_MESSAGE);
            }
            this.dispose();
        }
    }
